...
function addZoneToTable(_zone) {
  ...
  tr += '</td>'
  tr += '<td>'
  tr += '<input class="zoneAttr form-control input-sm" data-l1key="poids" placeholder="#"/>'
  tr += '</td>'
  tr += '<td>'
  tr += '<input class="zoneAttr form-control input-sm" data-l1key="gradiant" placeholder="{{°c/H}}"/>'
  tr += '</td>'
  tr += '<td>'
